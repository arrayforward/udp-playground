...
class JsonRpcTestEnv {
public:
    JsonRpcTestEnv(std::string sidecar, std::string hello_server,
    ...
    std::optional<std::string> json_rpc_call(int sid, bool sticky, int timeout_ms,
